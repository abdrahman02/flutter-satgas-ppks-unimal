...
class DetailSelesaiProsesPage extends StatefulWidget {
  final Pengaduan pengaduan;
  const DetailSelesaiProsesPage({
    Key? key,
    required this.pengaduan,
  }) : super(key: key);

  @override
  State<DetailSelesaiProsesPage> createState() =>
      _DetailSelesaiProsesPageState();
}

class _DetailSelesaiProsesPageState extends State<DetailSelesaiProsesPage> {
