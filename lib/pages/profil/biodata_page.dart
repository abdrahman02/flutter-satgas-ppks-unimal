...
class _BiodataPageState extends State<BiodataPage> {
  ...
  Widget build(BuildContext context) {
    final String nimNipNik = biodata["nip_nim_nik"] ?? "";
    final String tempatLahir = biodata["tempat_lahir"] ?? "";
    final String tanggalLahir = biodata["tanggal_lahir"] ?? "";
    final String noTelp = biodata["no_telepon"] ?? "";
    final String alamat = biodata["alamat"] ?? "";
    final String status = biodata["status"] ?? "";
    final String jenisKelamin = biodata["jenis_kelamin"] ?? "";
    final formKey = GlobalKey<FormState>();
    final nimNipNikC = TextEditingController(text: nimNipNik);
    final tempatLahirC = TextEditingController(text: tempatLahir);
    final tanggalLahirC = TextEditingController(text: tanggalLahir);
    final noTelpC = TextEditingController(text: noTelp);
    final alamatC = TextEditingController(text: alamat);
    String? selectedValueS = biodata["status"] ?? null;
    String? selectedValueJK = biodata["jenis_kelamin"] ?? null;
                  ...
                  onPressed: () async {
                    if (formKey.currentState!.validate()) {
                      final data = await ProfileService().editBio(
                        ...
                        status: status.isNotEmpty ? status : selectedValueS,
                        tempatLahir: tempatLahirC.text,
                        tanggalLahir: tanggalLahirC.text,
                        jenisKelamin:
                            jenisKelamin.isNotEmpty ? status : selectedValueJK,
                        noTelp: noTelpC.text,
                        alamat: alamatC.text,
                      );
                      showDialog(
